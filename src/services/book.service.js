...
function getEmptyBook(title = '', price = 0, rating = null, author = '', isInWishlist = false, description = '') {
    return {
        title,
        price,
        description,
...
function _createBooks() {
    let books = JSON.parse(localStorage.getItem(BOOK_DB_KEY)) || []
    if (!books || !books.length) {
        ...
        localStorage.setItem(BOOK_DB_KEY, JSON.stringify(books))
    }
}

// function _createBook(name, price, labels, inStock, imgUrl) {
//     const book = getEmptyBook(name, price, labels, inStock, imgUrl)
//     save(book)
//     return book
// }
